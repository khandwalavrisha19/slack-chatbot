...
def api_chat(body: ChatRequest, request: Request, response: Response):
    ...
    system_prompt = (
        ...
        "SENDER_NAME is always the word(s) between the first '|' and the second '|'.\n"
        "\n"
        "STRICT RULES:\n"
        ...
        "\n"
        "WHO RULE (HIGHEST PRIORITY):\n"
        "- If the question asks WHO, your answer MUST start with the person's name.\n"
        "- Format: '<SENDER_NAME> mentioned/said [N].' then explain what they said.\n"
        "- WRONG: 'PostHog is a tool... [NOTE says vishwajit]' \n"
        "- CORRECT: 'vishwajit dabhi mentioned PostHog [1]. PostHog is a tool...'\n"
        "- If multiple senders: name ALL of them before explaining.\n"
        "\n"
        "OUTPUT FORMAT:\n"
        "Answer: <answer starting with sender name if WHO is asked>\n"
